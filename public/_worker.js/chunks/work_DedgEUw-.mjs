...
import { o as objectType, d as dateType, n as numberType, a as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, r as renderTemplate, e as escape, b as renderUniqueStylesheet, f as renderScriptElement, g as createHeadAndContent, h as renderComponent, i as createAstro, m as maybeRenderHead, j as addAttribute, k as renderSlot } from './astro/server_CmeRRB0V.mjs';
...
import { $ as $$Icon, a as $$BaseLayout } from './Icon_BPBhjpnz.mjs';
/* empty css                        */
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_-d8jJ7xQ.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://varsha.de", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_bfIIp0sw.mjs').then(n => n._);
...
const $$Astro$3 = createAstro("https://varsha.de");
...
const $$ContactCTA = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<aside data-astro-cid-rcdzuq3a> <h2 data-astro-cid-rcdzuq3a>Ready to work together?</h2> <div class="contact-options" data-astro-cid-rcdzuq3a> ${renderComponent($$result, "CallToAction", $$CallToAction, { "href": "mailto:varsha@giessmann.net", "data-astro-cid-rcdzuq3a": true }, { "default": ($$result2) => renderTemplate`
Send Me a Message
${renderComponent($$result2, "Icon", $$Icon, { "icon": "paper-plane-tilt", "size": "1.2em", "data-astro-cid-rcdzuq3a": true })} ` })} ${renderComponent($$result, "CallToAction", $$CallToAction, { "href": "/pdfs/Lebenslauf_Varsha.pdf", "download": true, "data-astro-cid-rcdzuq3a": true }, { "default": ($$result2) => renderTemplate`
Download CV
${renderComponent($$result2, "Icon", $$Icon, { "icon": "download-simple", "size": "1.2em", "data-astro-cid-rcdzuq3a": true })} ` })} </div> <div class="contact-details" data-astro-cid-rcdzuq3a> <p data-astro-cid-rcdzuq3a>Tel. +49 178 511 2220</p> <p data-astro-cid-rcdzuq3a>Based in Germany • Available globally via remote interpretation</p> </div> </aside> `;
