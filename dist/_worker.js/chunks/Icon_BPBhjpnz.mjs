...
import { i as createAstro, c as createComponent, r as renderTemplate, j as addAttribute, h as renderComponent, l as renderHead, k as renderSlot, m as maybeRenderHead, p as spreadAttributes, u as unescapeHTML } from './astro/server_CmeRRB0V.mjs';
/* empty css                         */
/* empty css                        */
...
const iconPaths = {
  ...
  "book-open": `<path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" d="M128 88a52 52 0 0 0-52-52H32a8 8 0 0 0-8 8v144a8 8 0 0 0 8 8h44a52 52 0 0 1 52 52 52 52 0 0 1 52-52h44a8 8 0 0 0 8-8V44a8 8 0 0 0-8-8h-44a52 52 0 0 0-52 52Z"/>`,
  "download-simple": `<path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" d="M128 152V40m0 112l-40-40m40 40 40-40M56 208h144"/>`,
  "phone": `<path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" d="M222.37 158.46l-47.11-21.11-.13-.06a16 16 0 0 0-15.17 1.4l-25.15 19.85a8 8 0 0 1-8.73.66c-15.42-7.49-31.34-23.29-38.83-38.51a8 8 0 0 1 .66-8.73l19.85-25.15a16 16 0 0 0 1.4-15.17l-.06-.13-21.11-47.11a16 16 0 0 0-16.68-9.54A56.26 56.26 0 0 0 24 72c0 79.4 64.6 144 144 144a56.26 56.26 0 0 0 55.4-48.92 16 16 0 0 0-1.03-8.62Z"/>`,
...
export { $$Icon as $, $$BaseLayout as a };
